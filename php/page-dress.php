...
<noscript>
    <div><img src="https://mc.yandex.ru/watch/78111637" style="position:absolute; left:-9999px;" alt="" /></div>
</noscript>
<!-- /Yandex.Metrika counter -->

<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N4222NW" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->


<header class="header-dress">
    <div class="container">
        <div class='header-dress__body'>
            <!-- logo -->
            <a target="_blank" href="https://movehome.eu/" class='header-dress__logo'>
                <span class="header-dress__logo-name">
                    <img src="https://movehome.eu/wp-content/uploads/2020/03/move_home_2.png" alt="">
                </span>
            </a>
            <!-- burger -->
            <div class='header-dress__burger'>
                <span></span>
                <span></span>
                <span></span>
            </div>
            <!-- navigation -->
            <nav class='header-dress__menu'>
                <!-- header-dress__list -->
                <ul class='header-dress__list'>
                    <li class=''>
                        <a target="_blank" href='#customs_clearance' class='header-dress__link'>
                    ...
                    <li class=''>
                        <a target="_blank" href='#logistic_services' class='header-dress__link'>
                            <span class="link-hover">
                                логистика
                            </span>
                        </a>
                    ...
                    <li class=''>
                        <a target="_blank" href='#providers' class='header-dress__link'>
                            <span class="link-hover">
                                поставщики
                            </span>
                        </a>
                    ...
                    <li class=''>
                        <a target="_blank" href='#financial_services' class='header-dress__link'>
                            <span class="link-hover">
                                финансовые услуги
                            </span>
                        </a>
                    ...
                    <li class=''>
                        <a target="_blank" href='#anchor-form' class='header-dress__link'>
                            <span class="link-hover">
                                оставить заявку
                            </span>
                        </a>
    ...
    <section class="sub-header-dress-section">

        <div class="container">
            <div class="sub-header-dress">
                <div class="sub-header-dress__item">
                    <a class="sub-header-dress__link" href="tel:+7 812 30 99 100">
                        <i class="fas fa-phone" aria-hidden="true"></i> +7 812 30 99 100
                    </a>
                </div>
                <div class="sub-header-dress__item">
                    <div class="footer-social">
                        <div class="footer-social__item" style="color: #fff;">
                            <a class="footer-social__link" href="https://api.whatsapp.com/send?phone=37258329999&text=">
                                <i class="fab fa-whatsapp"></i>
                                WhatsApp
                            </a>
                        </div>
                        <div class="footer-social__item" style="color: #fff;">
                            <a class="footer-social__link" href="viber://chat?number=%2B37258329999">
                                <i class="fab fa-viber"></i>
                                Viber
                            </a>
                        </div>
                        <div class="footer-social__item footer-social__item_mob-hidden" style="color: #fff;">
                            |
                        </div>
                        <div class="footer-social__item footer-social__item_mob-hidden">
                            <a target="_blank" href="https://www.facebook.com/movehome.eu">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                        </div>
                        <div class="footer-social__item footer-social__item_mob-hidden">
                            <a target="_blank" href="https://ok.ru/movehome">
                                <i class="fab fa-odnoklassniki" aria-hidden="true"></i>
                            </a>
                        </div>
                        <div class="footer-social__item footer-social__item_mob-hidden">
                            <a target="_blank" href="https://www.instagram.com/movehome.eu/">
                                <i class="fab fa-instagram" aria-hidden="true"></i>
                            </a>

                        </div>
                        <div class="footer-social__item footer-social__item_mob-hidden">
                            <a target="_blank" href="https://vk.com/movehome">
...
<main class="main">
    ...
    <section class="section-page1">
        <div class="container">
            <div class="page1">
                <h1 class="page1__h1">
                    ДОСТАВКА И ТАМОЖЕННОЕ ОФОРМЛЕНИЕ ОДЕЖДЫ И ОБУВИ В РОССИЮ, А ТАК ЖЕ В СТРАНЫ СНГ!
                </h1>
                ...
                <a href="#anchor-form" class="first-screen-text__btn btn main-btn">
                    ...
                    <span class="btn__text">Экспресс расчёт стоимости</span>
                </a>
            </div>
        </div>
    </section>
    ...
    <div class="container">
                </svg>
                <span class="dress-nav__text">
                    <span>
                        Таможенные пошлины
                    </span>
                    <span>
            ...
            <a href="#logistic_services" class="dress-nav__item">
                <svg xmlns="http://www.w3.org/2000/svg" id="" height="50px" viewBox="0 0 512 512" width="50px">
                    <g>
            ...
            <a href="#providers" class="dress-nav__item">
                <svg xmlns="http://www.w3.org/2000/svg" id="" height="50px" viewBox="0 0 512 512" width="50px">
                    <g>
                        <path d="m131.75 244.4c-52.131 0-94.542 42.412-94.542 94.542 0 52.131 42.412 94.543 94.542 94.543s94.542-42.412 94.542-94.543c0-52.13-42.411-94.542-94.542-94.542zm0 174.086c-43.86 0-79.542-35.683-79.542-79.543s35.683-79.542 79.542-79.542 79.542 35.683 79.542 79.542c0 43.86-35.682 79.543-79.542 79.543z">
                        </path>
                        <path d="m173.336 292.576c-10.83-6.117-24.616-2.28-30.732 8.549l-16.507 29.229-4.391-5.664c-7.621-9.83-21.816-11.626-31.646-4.006-4.762 3.691-7.801 9.016-8.558 14.993-.756 5.978.86 11.892 4.551 16.653l25.175 32.474c4.241 5.47 10.904 8.736 17.825 8.736.542 0 1.087-.02 1.64-.06 7.55-.55 14.28-4.813 18.002-11.405l33.19-58.768c6.116-10.827 2.282-24.614-8.549-30.731zm-4.511 23.357-33.19 58.768c-1.247 2.208-3.501 3.636-6.024 3.82-2.516.174-4.993-.928-6.527-2.907l-25.175-32.474c-1.236-1.595-1.778-3.576-1.524-5.579s1.271-3.786 2.867-5.022c1.375-1.066 3.003-1.582 4.621-1.582 2.258 0 4.493 1.005 5.98 2.923l11.302 14.578c1.539 1.984 3.964 3.075 6.472 2.885 2.504-.182 4.751-1.605 5.986-3.792l22.053-39.05c2.049-3.628 6.668-4.911 10.295-2.865 3.627 2.051 4.912 6.669 2.864 10.297z">
                        </path>
                        <path d="m380.25 244.402c-52.13 0-94.54 42.411-94.54 94.54s42.41 94.54 94.54 94.54c18.57 0 36.545-5.384 51.98-15.57 3.457-2.281 4.41-6.934 2.129-10.391-2.282-3.458-6.934-4.41-10.391-2.129-12.977 8.563-28.095 13.09-43.719 13.09-43.858 0-79.54-35.682-79.54-79.54s35.682-79.54 79.54-79.54 79.54 35.682 79.54 79.54c0 17.527-5.582 34.141-16.143 48.043-2.505 3.299-1.862 8.003 1.437 10.509 3.297 2.504 8.003 1.862 10.509-1.436 12.559-16.535 19.197-36.285 19.197-57.117.001-52.129-42.409-94.539-94.539-94.539z">
                        </path>
                        <path d="m422.056 96.688c-10.232-32.81-40.634-55.38-75.367-55.38-43.373 0-78.806 35.285-78.985 78.688v33.211c-4.711 7.719-8.643 15.961-11.702 24.612-3.062-8.656-6.996-16.903-11.711-24.626v-33.237c-.179-43.367-35.607-78.648-78.976-78.648-34.732 0-65.131 22.559-75.37 55.355-10.343 3.457-20.261 8.207-29.531 14.187-3.48 2.246-4.482 6.888-2.236 10.368 2.246 3.481 6.886 4.481 10.368 2.236 18.833-12.15 40.688-18.572 63.204-18.572 64.376 0 116.75 52.374 116.75 116.75v.004 56.31c-22.042-42.019-66.101-70.752-116.75-70.752s-94.708 28.733-116.75 70.751v-56.313c0-30.312 11.57-59.043 32.578-80.903 2.87-2.986 2.776-7.734-.211-10.604-2.986-2.87-7.734-2.776-10.604.211-23.707 24.666-36.763 57.09-36.763 91.296v117.31s0 0 0 .001c0 72.647 59.103 131.75 131.75 131.75 57.292 0 106.151-36.763 124.25-87.935 18.098 51.172 66.958 87.935 124.25 87.935 72.647 0 131.75-59.103 131.75-131.75v-117.308c0-58.04-37.727-107.43-89.944-124.947zm-290.306-6.806c-8.063 0-16.05.736-23.879 2.171 10.566-21.553 32.643-35.746 57.443-35.746 35.131 0 63.831 28.58 63.976 63.679v13.17c-24.12-26.567-58.915-43.274-97.54-43.274zm150.953 30.145c.146-35.135 28.85-63.719 63.985-63.719 24.796 0 46.87 14.195 57.436 35.751-7.745-1.424-15.723-2.173-23.874-2.173-38.628 0-73.427 16.711-97.547 43.282zm-150.953 335.666c-64.376 0-116.75-52.374-116.75-116.75s52.374-116.75 116.75-116.75 116.75 52.374 116.75 116.75-52.374 116.75-116.75 116.75zm248.5 0c-64.376 0-116.75-52.374-116.75-116.75s52.374-116.75 116.75-116.75 116.75 52.374 116.75 116.75-52.374 116.75-116.75 116.75zm0-248.5c-50.65 0-94.708 28.734-116.75 70.752v-56.31c0-64.376 52.374-116.75 116.75-116.75s116.75 52.375 116.75 116.75v56.31c-22.042-42.018-66.1-70.752-116.75-70.752z">
                        </path>
                        <path d="m391.104 301.125-16.507 29.229-4.392-5.664c-7.62-9.83-21.817-11.625-31.646-4.006-9.829 7.621-11.627 21.817-4.007 31.646l25.176 32.473c4.24 5.471 10.904 8.737 17.825 8.737.542 0 1.088-.02 1.641-.06 7.552-.55 14.281-4.814 18.001-11.405l33.189-58.768c6.116-10.83 2.281-24.616-8.548-30.733-10.828-6.112-24.614-2.277-30.732 8.551zm26.22 14.808-33.19 58.769c-1.246 2.207-3.5 3.635-6.023 3.819-2.509.179-4.993-.928-6.526-2.907l-25.176-32.474c-2.553-3.292-1.95-8.048 1.342-10.601 1.375-1.066 3.004-1.582 4.622-1.582 2.258 0 4.492 1.005 5.979 2.923l11.302 14.578c1.539 1.984 3.967 3.074 6.473 2.885 2.504-.182 4.751-1.605 5.985-3.792l22.054-39.05c2.049-3.628 6.668-4.912 10.296-2.865 3.627 2.05 4.911 6.669 2.862 10.297z">
                        </path>
                    </g>
                </svg>
                <span class="dress-nav__text">
            ...
            <div class="container">
                <div class="page-form__row">
                    <div class="page-form__item">
                        <img class="page-form__img page-form__img_dress" src="https://movehome.eu/wp-content/uploads/2021/04/34811-1-1559x2048-1.png" alt="">
                    </div>
                    <div class="page-form__item">
                        <h2 class="sub-h2 sub-h2_dress">
                            БЕСПЛАТНЫЙ РАСЧЕТ СТОИМОСТИ
                        </h2>
                        <?php echo do_shortcode('[contact-form-7 id="123" title="Главная (верхняя)"]') ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="customs_clearance" class="section-dress-services">
        <div class="container">
            <div class="dress-services">

                <h2 class="dress-services__h2 sub-h2_dress">
                    ТАМОЖЕННОЕ ОФОРМЛЕНИЕ ОТ 1 ЕВРО ЗА КГ
                </h2>
                <span class="dress-services__descr">
                    Занимается маркировкой и таможенным оформлением одежды, обуви, сумок и текстиля
                </span>

                <div class="dress-services__body">

                    <div class="dress-services__item">
                        <div>
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 496.004 496.004" style="enable-background:new 0 0 496.004 496.004;" xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
                        ...
                        <h3 class="dress-services__h3">
                            Одежда
                        </h3>

                        <div class="dress-services__text-box">

                        </div>

                        <div>
                            <span class="dress-services__price">
                                ОТ 5 € / кг
                            </span>
                            <a data-fancybox data-src="#popup_kids-dress" class="first-screen-text__btn btn main-btn">
			...
			C177.139,286.462,178.172,291.159,181.707,293.419z" />
                        ...
                        <div>
                            ...
                            <a data-fancybox data-src="#popup_shoes" class="first-screen-text__btn btn main-btn">
                                <span class="btn__text">Подробнее</span>
                            </a>
                        </div>
                    </div>
			...
			c0,6.982,4.655,11.636,11.636,11.636c6.982,0,11.636-4.655,11.636-11.636V69.818C349.091,50.036,333.964,34.909,314.182,34.909z" />
                        ...
                        <div>
                            ...
                            <a data-fancybox data-src="#popup_bag" class="first-screen-text__btn btn main-btn">
                                <span class="btn__text">подробнее</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="dress-services__item">
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 64 64" width="512" height="512">
                                <path d="M42.65918,4.247l-.01025-.01209-1.356-1.356A2.97977,2.97977,0,0,0,39.17139,2H24.82861a2.97977,2.97977,0,0,0-2.12158.87891l-1.356,1.356-.01025.01209L17.125,7.61914A2.98759,2.98759,0,0,0,16,9.96143V33a2.97711,2.97711,0,0,0,.78027,2A2.97711,2.97711,0,0,0,16,37V59a3.00328,3.00328,0,0,0,3,3H45a3.00328,3.00328,0,0,0,3-3V37a2.97711,2.97711,0,0,0-.78027-2A2.97711,2.97711,0,0,0,48,33V9.96143a2.98721,2.98721,0,0,0-1.126-2.34278ZM46,9.96143V33a1.0013,1.0013,0,0,1-1,1H33V15.08044l1.5127,1.21009a3.00028,3.00028,0,0,0,4.50781-.90576L43.16113,7.793a2.95205,2.95205,0,0,0,.1908-.431L45.624,9.17969A.99642.99642,0,0,1,46,9.96143ZM46,37v6H44V36h1A1.0013,1.0013,0,0,1,46,37ZM33,55.92017A7.00476,7.00476,0,0,1,27,49V45h6ZM18,37a1.0013,1.0013,0,0,1,1-1h1v7H18Zm4-1h2v7H22Zm4,7V36H38v7Zm14-7h2v7H40ZM37.61816,4h1.55323a.99428.99428,0,0,1,.70752.293l1.356,1.356a1.00486,1.00486,0,0,1,.17041,1.186l-4.14062,7.5918a.99993.99993,0,0,1-1.50293.30224l-2.50586-2.00488ZM35.3819,4,32,10.764,28.6181,4ZM22.76514,5.64893l1.356-1.356A.99428.99428,0,0,1,24.82861,4h1.55323l4.3623,8.72412L28.23828,14.729a.99993.99993,0,0,1-1.50293-.30224L22.59473,6.835A1.00486,1.00486,0,0,1,22.76514,5.64893ZM18,9.96143a.99681.99681,0,0,1,.375-.78125l2.27307-1.81836a2.95055,2.95055,0,0,0,.1908.43115l4.14062,7.5918a2.9996,2.9996,0,0,0,4.50781.90576L31,15.08044V34H19a1.0013,1.0013,0,0,1-1-1ZM18,59V45h7v4a9.01084,9.01084,0,0,0,8,8.941V60H19A1.0013,1.0013,0,0,1,18,59Zm27,1H35V45H46V59A1.0013,1.0013,0,0,1,45,60Z" />
                                <path d="M12.52783,14.82031A5.0332,5.0332,0,0,1,12,12.5835V2H10V12.5835a7.039,7.039,0,0,0,.73877,3.13086l.7334,1.46533A5.0332,5.0332,0,0,1,12,19.4165V29a1,1,0,0,1-2,0V23H8v7.2749a4.99147,4.99147,0,0,0,.31836,1.75537l2.20654,5.88428a.93353.93353,0,0,1-1.68457.791l-2.9458-5.15284L4.31689,30.39746A3.01221,3.01221,0,0,1,4,29.05566V2H2V29.05566A5.02811,5.02811,0,0,0,2.52783,31.292l1.604,3.2041L7.104,39.69824a2.93373,2.93373,0,0,0,5.294-2.48584l-1.9765-5.27087A2.99006,2.99006,0,0,0,14,29V19.4165a7.039,7.039,0,0,0-.73877-3.13086Z" />
                                <path d="M60,2V29.05566a3.01221,3.01221,0,0,1-.31689,1.3418l-1.55127,3.10645-2.97217,5.20117a.93338.93338,0,0,1-1.68457-.79053l2.20654-5.88428A4.99147,4.99147,0,0,0,56,30.2749V23H54v6a1,1,0,0,1-2,0V19.4165a5.02959,5.02959,0,0,1,.52783-2.23632l.7334-1.46631A7.03537,7.03537,0,0,0,54,12.5835V2H52V12.5835a5.02959,5.02959,0,0,1-.52783,2.23632l-.7334,1.46631A7.03537,7.03537,0,0,0,50,19.4165V29a2.99006,2.99006,0,0,0,3.57855,2.94153l-1.9765,5.27087a2.93362,2.93362,0,0,0,5.294,2.48535l2.99853-5.25048L61.47217,31.292A5.02811,5.02811,0,0,0,62,29.05566V2Z" />
                        ...
                        <div>
                            ...
                            <a data-fancybox data-src="#popup_second" class="first-screen-text__btn btn main-btn">
                                <span class="btn__text">подробнее</span>
                            </a>
                        </div>
                    </div>
    ...
    <section id="logistic_services" class="section-logistic">
        <div class="container">
            <div class="logistic">
                <h2 class="logistic__h2 sub-h2_dress">
                    ЛОГИСТИЧЕСКИЕ УСЛУГИ
                </h2>
                <span class="logistic__descr">
                    Заказы на доставку сборных грузов от 1 кг из Америки, Европы и Китая
                </span>


                <div class="logistic__body">
                    <div class="logistic__item">

                        <div class="logistic__img">
                            <img src="https://movehome.eu/wp-content/uploads/2021/04/sbornye-1.png" alt="">
                        </div>

                        <div class="logistic__text">
                            <h3 class="logistic__h3">
                                СБОРНЫЕ ПЕРЕВОЗКИ
                            </h3>
                            <p class="logistic__p">
                                Наиболее удобный и экономичный способ доставки небольшой партии товара или
                                продукции.
                            </p>
                            <a data-fancybox data-src="#popup_complex" class="btn main-btn">
                                Подробнее
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="logistic__item">
                        ...
                        <div class="logistic__img">
                            <img src="https://movehome.eu/wp-content/uploads/2021/04/admin-ajax11.png" alt="">
                        </div>
                        ...
                        <div class="logistic__text">
                            ...
                            <p class="logistic__p">
                                Входит в схемы мультимодальной доставки грузов из Вьетнама, Израиля, Индии,
                                Индонезии, Канады, Кореи, Сингапура, США, Таиланда и др.

                            </p>
                            <a data-fancybox data-src="#popup_sea" class="btn main-btn">
                                Подробнее
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="logistic__item">
                        ...
                        <div class="logistic__img">
                            <img src="https://movehome.eu/wp-content/uploads/2021/04/avtoperevozka.png" alt="">
                        </div>
                        ...
                        <div class="logistic__text">
                            ...
                            <p class="logistic__p">
                                Доставляем даже самые маленькие грузы. Мы организовываем автомобильные
                                грузоперевозки из США, Китая или ЕС во все регионы России

                            </p>
                            <a data-fancybox data-src="#popup_auto" class="btn main-btn">
                                Подробнее
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="logistic__item">
                        ...
                        <div class="logistic__img">
                            <img src="https://movehome.eu/wp-content/uploads/2021/04/business-jet-dassault-falcon-3d-model_0-1.png" alt="">
                        </div>
                        ...
                        <div class="logistic__text">
                            ...
                            <p class="logistic__p">
                                Лучший способ транспортировки товаров, требующих быстрой доставки. Осуществляем
                                авиаперевозки по всему миру

                            </p>
                            <a data-fancybox data-src="#popup_sky" class="btn main-btn">
                                Подробнее
                            </a>
                        </div>
                    </div>
    ...
    <section id="providers" class="section-provider">
        <div class="container">
            <div class="provider">

                <h2 class="logistic__h2 sub-h2_dress">
                    ПОИСК ПОСТАВЩИКОВ ОДЕЖДЫ И ОБУВИ
                </h2>
                <span class="logistic__descr">
                    Поможем вам найти необходимые товары и услуги за границей. У нас есть для этого проработанная
                    схема
                </span>
                ...
                <div class="provider__row">
                    <div class="provider__item">
                        ...
                        <div class="provider-item">
                            <svg xmlns="http://www.w3.org/2000/svg" id="" viewBox="0 0 511.999 511.999">
                                <g>
                                    ...
                                    <path d="m212.299 276.443c5.523 0 10-4.478 10-10s-4.477-10-10-10h-.007c-5.523 0-9.996 4.478-9.996 10s4.48 10 10.003 10z">
                                    </path>
                                </g>
                            </svg>

                            <div class="provider-item__text">
                                <h3 class="provider-item__h3">
                                    ВСЕ НАЧИНАЕТСЯ С ВАШИХ ТРЕБОВАНИЙ
                                </h3>
                                <p class="provider-item__p">
                                    Определяем тип производителя и поставщика услуг, которого вы ищите, и используем
                                    свои деловые связи, чтобы подобрать нужных поставщиков
                                </p>
                            </div>
                        </div>

                        <div class="provider-item">
                            <svg xmlns="http://www.w3.org/2000/svg" id="" height="512" viewBox="0 0 511.999 511.999" width="512">
                                <g>
                                    <g>
                            ...
                            <div class="provider-item__text">
                                <h3 class="provider-item__h3">
                                    ИЩЕМ ПОТЕНЦИАЛЬНЫЕ ПРЕДЛОЖЕНИЯ
                                </h3>
                                <p class="provider-item__p">
                                    Помогаем определить объем закупки и продолжительность контракта. Если вы уже
                                    знаете, в какой стране вы хотите искать поставщиков, вы можем начать именно там
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="provider__item">
                        <img src="https://movehome.eu/wp-content/uploads/2021/04/odezhda2-1.png" alt="">
                    </div>
                    ...
                    <div class="provider__item">
                        ...
                        <div class="provider-item">
                            ...
                            <div class="provider-item__text">
                                <h3 class="provider-item__h3">
                                    ПОМОГАЕМ В ПЕРЕГОВОРАХ С ПОСТАВЩИКАМИ
                                </h3>
                                <p class="provider-item__p">
                                    Присоединимся к вам во время видео-конференций или поможем вам во время встреч.
                                    Так мы оптимизируем ваш процесс коммуникации с поставщиками
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="provider-item">
                            ...
                            <div class="provider-item__text">
                                <h3 class="provider-item__h3">
                                    ГАРАНТИРУЕМ ПОЛУЧЕНИЕ ТОВАРА НА СКЛАДЕ
                                </h3>
                                <p class="provider-item__p">
                                    Мы поможем отследить статус посылки и соблюдение сроков доставки, так же мы
                                    гарантируем, что вы получите необходимый продукт на складе в нужные сроки
                                </p>
                            </div>
                        </div>
    ...
    <section id="financial_services" class="section-finance">
        <div class="finance">

            <div class="container">
                <h2 class="logistic__h2 sub-h2_dress">
                    ФИНАНСОВЫЕ УСЛУГИ ВЭД
                </h2>
                <span class="logistic__descr">
                    Наша компания позаботится о Вашей финансовой безопасности, и сделает так, чтобы каждая
                    заключенная сделка стала для выгодной и успешной
                </span>
                ...
                <div class="finance__body">
                    <div class="finance__item">
                        <div class="finance__img">
                            <svg xmlns="http://www.w3.org/2000/svg" height="480pt" viewBox="0 0 480.08177 480" width="480pt">
                        ...
                        <div class="finance__text">
                            <h3 class="finance__h3">
                                СОПРОВОЖДЕНИЕ ВАШЕЙ
                                СДЕЛКИ
                            </h3>
                            <p class="finance__p">
                                Заключение контракта, оплата товара в валюте, доставка и таможенное оформление
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="finance__item">
                        <div class="finance__img">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="" x="0px" y="0px" viewBox="0 0 496.188 496.188" style="enable-background:new 0 0 496.188 496.188;" xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
                                            <path d="M380.612,0H8.659C4.141,0,1.129,3.012,1.129,7.529v479.623c0,4.518,3.012,7.529,7.529,7.529h371.953     c4.518,0,7.529-3.012,7.529-7.529V7.529C388.141,3.012,385.129,0,380.612,0z M16.188,15.059h356.894V204.8H16.188V15.059z      M373.082,478.871H16.188V219.859h356.894V478.871z">
                                            </path>
                                            <path d="M342.212,39.906h-294.4c-4.518,0-7.529,3.012-7.529,7.529V179.2c0,4.518,3.012,8.282,7.529,8.282h294.4     c4.518,0,7.529-3.012,7.529-7.529V47.435C349.741,42.918,346.729,39.906,342.212,39.906z M334.682,171.671H55.341V54.965h279.341     V171.671z">
                                            </path>
                                            <path d="M47.812,309.459h42.165c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-3.765-3.012-7.529-7.529-7.529H47.812     c-4.518,0-7.529,3.012-7.529,7.529v42.165C40.282,306.447,43.294,309.459,47.812,309.459z M55.341,268.047h27.106v27.106H55.341     V268.047z">
                                            </path>
                                            <path d="M131.388,309.459h42.918c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-3.765-3.765-7.529-7.529-7.529h-42.918     c-4.518,0-7.529,3.012-7.529,7.529v42.165C123.859,306.447,126.871,309.459,131.388,309.459z M138.918,268.047h27.859v27.106     h-27.859V268.047z">
                                            </path>
                                            <path d="M214.965,309.459h42.918c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-3.765-3.012-7.529-7.529-7.529h-42.918     c-4.518,0-7.529,3.012-7.529,7.529v42.165C207.435,306.447,210.447,309.459,214.965,309.459z M222.494,268.047h27.859v27.106     h-27.859V268.047z">
                                            </path>
                                            <path d="M298.541,309.459h42.918c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-3.765-3.012-7.529-7.529-7.529h-42.918     c-4.518,0-7.529,3.012-7.529,7.529v42.165C291.012,306.447,294.024,309.459,298.541,309.459z M306.071,268.047h27.859v27.106     h-27.859V268.047z">
                                            </path>
                                            <path d="M47.812,386.259h42.165c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-4.518-3.012-7.529-7.529-7.529H47.812     c-4.518,0-7.529,3.012-7.529,7.529v42.165C40.282,383.247,43.294,386.259,47.812,386.259z M55.341,344.094h27.106V371.2H55.341     V344.094z">
                                            </path>
                                            <path d="M131.388,386.259h42.918c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-4.518-3.765-7.529-7.529-7.529h-42.918     c-4.518,0-7.529,3.012-7.529,7.529v42.165C123.859,383.247,126.871,386.259,131.388,386.259z M138.918,344.094h27.859V371.2     h-27.859V344.094z">
                                            </path>
                                            <path d="M214.965,386.259h42.918c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-4.518-3.012-7.529-7.529-7.529h-42.918     c-4.518,0-7.529,3.012-7.529,7.529v42.165C207.435,383.247,210.447,386.259,214.965,386.259z M222.494,344.094h27.859V371.2     h-27.859V344.094z">
                                            </path>
                                            <path d="M298.541,462.306h42.918c4.518,0,7.529-3.012,7.529-7.529V336.565c0-4.518-3.012-7.529-7.529-7.529h-42.918     c-4.518,0-7.529,3.012-7.529,7.529v118.212C291.012,459.294,294.024,462.306,298.541,462.306z M306.071,344.094h27.859v103.153     h-27.859V344.094z">
                                            </path>
                                            <path d="M47.812,462.306h42.165c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-4.518-3.012-7.529-7.529-7.529H47.812     c-4.518,0-7.529,3.012-7.529,7.529v42.165C40.282,459.294,43.294,462.306,47.812,462.306z M55.341,420.141h27.106v27.106H55.341     V420.141z">
                                            </path>
                                            <path d="M131.388,462.306h42.918c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-4.518-3.765-7.529-7.529-7.529h-42.918     c-4.518,0-7.529,3.012-7.529,7.529v42.165C123.859,459.294,126.871,462.306,131.388,462.306z M138.918,420.141h27.859v27.106     h-27.859V420.141z">
                                            </path>
                                            <path d="M214.965,462.306h42.918c4.518,0,7.529-3.012,7.529-7.529v-42.165c0-4.518-3.012-7.529-7.529-7.529h-42.918     c-4.518,0-7.529,3.012-7.529,7.529v42.165C207.435,459.294,210.447,462.306,214.965,462.306z M222.494,420.141h27.859v27.106     h-27.859V420.141z">
                                            </path>
                                            <path d="M492.8,170.918c0-20.329-15.812-36.894-34.635-36.894h-10.541c-19.576,0-33.882,17.318-33.882,36.894     c0,30.118,2.259,192.753,2.259,214.588c0,0.753,0,0.753,0,0.753v0.753l33.129,103.906c0.753,3.012,3.765,5.271,7.529,5.271     c3.012,0,6.024-2.259,6.776-5.271l30.871-103.906v-0.753c0.753,0,0.753-0.753,0.753-0.753     C494.306,305.694,493.553,254.494,492.8,170.918z M448.376,149.082h10.541c10.541,0,18.823,9.788,19.576,21.835v26.353h-48.188     v-26.353C428.8,158.871,437.835,149.082,448.376,149.082z M456.659,463.812l-22.588-70.776h42.918L456.659,463.812z      M431.059,377.976l-1.506-165.647h48.188l1.506,165.647H431.059z">
                                            </path>
                                            <polygon points="120.847,146.824 135.153,146.824 135.153,93.365 153.976,93.365 153.976,80.565 102.024,80.565 102.024,93.365      120.847,93.365    ">
                                            </polygon>
                                            <path d="M167.529,146.824l6.023-14.306h27.859l6.024,14.306h15.812l-28.612-66.259h-14.306l-28.612,66.259H167.529z      M187.106,100.141l8.282,19.576h-16.565L187.106,100.141z">
                                            </path>
                                            <polygon points="241.318,146.824 255.624,124.988 269.929,146.824 288,146.824 265.412,112.188 285.741,80.565 268.423,80.565      255.624,100.141 242.824,80.565 225.506,80.565 245.835,112.941 224,146.824    ">
                                            </polygon>
                                        </g>
                                    </g>
                                </g>
                        ...
                        <div class="finance__text">
                            ...
                            <p class="finance__p">
                                Оптимизируем ваши затраты на уплату налогов, сборов и других обязательных платежей
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="finance__item">
                        <div class="finance__img">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="" x="0px" y="0px" viewBox="0 0 480 480" style="enable-background:new 0 0 480 480;" xml:space="preserve">
                                <g>
                                    <g>
                        ...
                        <div class="finance__text">
                            ...
                            <p class="finance__p">
                                Бухгалтерские и сопутствующие услуги для организаций и индивидуальных
                                предпринимателей
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="finance__item">
                        <div class="finance__img">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" height="480pt" viewBox="-80 0 480 480" width="480pt">
                                <path d="m72 336h176c13.25-.015625 23.984375-10.75 24-24v-42.960938l-16-18.667968v-162.371094c-.015625-13.25-10.75-23.984375-24-24h-120c-13.25.015625-23.984375 10.75-24 24v8h-16c-13.25.015625-23.984375 10.75-24 24v192c.015625 13.25 10.75 23.984375 24 24zm184-24c-.003906 4.417969-3.582031 7.996094-8 8h-24v-82.375l32 37.335938zm-152-224c.003906-4.417969 3.582031-7.996094 8-8h120c4.417969.003906 7.996094 3.582031 8 8v143.707031l-16-18.664062v-93.042969c-.015625-13.25-10.75-23.984375-24-24h-96zm-40 32c.003906-4.417969 3.582031-7.996094 8-8h128c4.417969.003906 7.996094 3.582031 8 8v200h-136c-4.417969-.003906-7.996094-3.582031-8-8zm0 0">
                                </path>
                                <path d="m296 0h-272c-13.25.015625-23.984375 10.75-24 24v432c.015625 13.25 10.75 23.984375 24 24h272c13.25-.015625 23.984375-10.75 24-24v-432c-.015625-13.25-10.75-23.984375-24-24zm-272 16h272c4.417969.003906 7.996094 3.582031 8 8v360h-288v-360c.003906-4.417969 3.582031-7.996094 8-8zm272 448h-272c-4.417969-.003906-7.996094-3.582031-8-8v-56h288v56c-.003906 4.417969-3.582031 7.996094-8 8zm0 0">
                                </path>
                                <path d="m176 432c0 8.835938-7.164062 16-16 16s-16-7.164062-16-16 7.164062-16 16-16 16 7.164062 16 16zm0 0">
                                </path>
                                <path d="m64 424h32v16h-32zm0 0"></path>
                                <path d="m224 424h32v16h-32zm0 0"></path>
                                <path d="m176 192v-8c-.011719-8.832031-7.167969-15.988281-16-16h-16v-16h-16v16h-16c-8.832031.011719-15.988281 7.167969-16 16v24c.011719 8.832031 7.167969 15.988281 16 16h16v24h-16v-8h-16v8c.011719 8.832031 7.167969 15.988281 16 16h16v16h16v-16h16c8.832031-.011719 15.988281-7.167969 16-16v-24c-.011719-8.832031-7.167969-15.988281-16-16h-16v-24h16v8zm-16 32v24h-16v-24zm-32-16h-16v-24h16zm0 0">
                                </path>
                            </svg>
                        ...
                        <div class="finance__text">
                            ...
                            <p class="finance__p">
                                Если вы не имеете расчетные счета в банке, при необходимости, мы поможем вам с их
                                открытием
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="finance__item">
                        <div class="finance__img">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="" x="0px" y="0px" width="87.518px" height="87.518px" viewBox="0 0 87.518 87.518" style="enable-background:new 0 0 87.518 87.518;" xml:space="preserve">
                                <g>
                                    <g>
                        ...
                        <div class="finance__text">
                            ...
                            <p class="finance__p">
                                Помощь в прохождении проверок банка при валютных расчётах с производителями
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="finance__item">
                        <div class="finance__img">
                            <svg xmlns="http://www.w3.org/2000/svg" height="342pt" viewBox="0 -1 342.2545 342" width="342pt">
                                <path d="m333.691406 113.640625-16.042968-16.046875c-8.976563-9.070312-22.945313-10.9375-33.988282-4.539062v-19.175782c0-1.507812-.597656-2.949218-1.664062-4.011718l-68.078125-68.078126c-1.0625-1.066406-2.503907-1.664062-4.007813-1.664062h-170.199218c-3.132813 0-5.671876 2.542969-5.671876 5.675781v28.363281h-28.367187c-3.132813 0-5.671875 2.542969-5.671875 5.675782v295.007812c0 3.132813 2.539062 5.671875 5.671875 5.671875h238.277344c3.132812 0 5.671875-2.539062 5.671875-5.671875v-28.367187h28.367187c3.132813 0 5.671875-2.539063 5.671875-5.671875v-97.011719l50.03125-50.03125c11.078125-11.078125 11.078125-29.039063 0-40.117187zm-20.054687 44.125-8.023438 8.015625-40.105469-40.105469 8.019532-8.023437zm-104.296875 104.304687-40.121094-40.121093 88.257812-88.253907 40.117188 40.117188zm-44.125-28.089843 32.09375 32.101562-37.445313 5.34375zm99.078125-165.777344h-48.710938v-48.707031zm-26.019531 260.96875h-226.925782v-283.660156h22.691406v255.292969c0 3.132812 2.539063 5.671874 5.671876 5.671874h198.5625zm34.039062-34.039063h-226.925781v-283.660156h158.847656v62.40625c0 3.132813 2.539063 5.671875 5.671875 5.671875h62.40625v23.257813l-2.800781 2.808594-112.328125 112.332031c-.480469.492187-.863282 1.070312-1.136719 1.703125-.1875.484375-.34375.984375-.464844 1.492187l-8.023437 56.164063c-.441406 3.101562 1.710937 5.976562 4.8125 6.421875.265625.035156.535156.058593.804687.058593s.539063-.019531.804688-.058593l56.167969-8.023438c.507812-.121093 1.007812-.277343 1.496093-.46875.632813-.269531 1.210938-.65625 1.703125-1.136719l58.964844-58.960937zm53.359375-149.398437-4.011719 4.011719-40.117187-40.128906.359375-.355469.164062-.164063 3.488282-3.496094c6.738281-6.429687 17.335937-6.429687 24.074218 0l16.042969 16.050782c6.644531 6.644531 6.648437 17.421875 0 24.066406v.003906zm0 0">
                                </path>
                                <path d="m269.507812 177.824219 8.023438-8.023438 8.023438 8.023438-8.023438 8.023437zm0 0">
                                </path>
                                <path d="m205.328125 242.011719 56.160156-56.160157 8.023438 8.023438-56.160157 56.160156zm0 0">
                                </path>
                                <path d="m85.097656 73.878906c12.535156 0 22.695313-10.160156 22.695313-22.695312 0-12.53125-10.160157-22.691406-22.695313-22.691406-12.53125 0-22.691406 10.160156-22.691406 22.691406 0 12.535156 10.160156 22.695312 22.691406 22.695312zm0-34.039062c6.265625 0 11.347656 5.078125 11.347656 11.347656 0 6.265625-5.082031 11.34375-11.347656 11.34375s-11.34375-5.078125-11.34375-11.34375c0-6.269531 5.078125-11.347656 11.34375-11.347656zm0 0">
                                </path>
                                <path d="m119.136719 45.511719h68.078125v11.347656h-68.078125zm0 0"></path>
                                <path d="m68.078125 141.957031h124.8125v-51.058593h-124.8125zm11.347656-39.714843h102.117188v28.367187h-102.117188zm0 0">
                                </path>
                                <path d="m68.078125 164.648438h11.347656v11.347656h-11.347656zm0 0"></path>
                                <path d="m90.769531 164.648438h79.425781v11.347656h-79.425781zm0 0"></path>
                                <path d="m68.078125 187.34375h11.347656v11.34375h-11.347656zm0 0"></path>
                                <path d="m90.769531 187.34375h79.425781v11.34375h-79.425781zm0 0"></path>
                                <path d="m68.078125 210.035156h11.347656v11.347656h-11.347656zm0 0"></path>
                                <path d="m90.769531 210.035156h56.734375v11.347656h-56.734375zm0 0"></path>
                                <path d="m68.078125 232.726562h11.347656v11.347657h-11.347656zm0 0"></path>
                                <path d="m90.769531 232.726562h51.0625v11.347657h-51.0625zm0 0"></path>
                                <path d="m68.078125 255.421875h11.347656v11.34375h-11.347656zm0 0"></path>
                                <path d="m90.769531 255.421875h45.386719v11.34375h-45.386719zm0 0"></path>
                            </svg>
                        </div>
                        ...
                        <div class="finance__text">
                            ...
                            <p class="finance__p">
                                Внесение изменений в учредительные документы (смена руководителя, наименования, юр.
                                адреса и прочее)
                            </p>
                        </div>
                    </div>
                ...
                <div style="display: flex; justify-content: center; margin-top: 20px;">
                    <a data-fancybox data-src="#popup_finance" class="first-screen-text__btn btn main-btn" ">
                            <span class=" btn__text">Подробнее</span>
                    </a>
                </div>
    ...
    <section class="section-insurance">
        <div class="container">
            ...
            <h2 class="logistic__h2 sub-h2_dress">
                СТРАХОВАНИЕ ГРУЗА НА ПУТИ СЛЕДОВАНИЯ
            </h2>
            <span class="logistic__sub-h2">
                Стоимость страхования от 0,12% до 0,145% от инвойсной стоимости
            </span>
            ...
            <div class="insurance">
                <div class="insurance__row">
                    ...
                    <div class="insurance__item">
                        ...
                        <div class="insurance-item">
                            <div class="insurance-item__item">
                                <svg fill="#FE9934" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            ...
                            <div class="insurance-item__item">
                                ...
                                <p>
                                    С момента приема груза в пункте
                                    отправления и в течение всей
                                    перевозки (включая перегрузки, промежуточное хранение до 60 дней) вплоть до
                                    момента доставки груза
                                    на конечный пункт.
                                    Возмещению подлежат убытки,
                                    возникшие вследствие повреждения, гибели, кражи груза, расходы по его спасанию,
                                    ремонту и др.
                                </p>
                            </div>
                        </div>
            ...
            <div class="insurance-sub">
                ...
                <div class="insurance-sub__item">
                    ...
                    <p class="insurance-sub__text">
                        Международные условия ICC(A) от ведущих лондонских страховых компаний
                    </p>
                </div>
                <div class="insurance-sub__item">
                    <div class="insurance-sub__icon-wrap">
                    ...
                    <p class="insurance-sub__text">
                        Страхование вашего товара начиная от 1 евро
                    </p>
                </div>
            </div>
            ...
            <div class="warehouse__btn">
                <a data-fancybox data-src="#popup_safe" class="first-screen-text__btn btn main-btn">
                    <span class="btn__text">Подробнее</span>
                </a>
            </div>
    ...
    <section class="section-warehouse">
        <div class="container">
            ...
            <h2 class="logistic__h2 sub-h2_dress">
                СКЛАДСКИЕ УСЛУГИ НА ТЕРРИТОРИИ АМЕРИКИ, ЕВРОПЫ И КИТАЯ
            </h2>
            ...
            <div class="warehouse">
                <div class="warehouse__body">
                        ...
                        <div class="warehouse__img">
                            <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
                                <g id="Outline">
                                    ...
                                    <path d="M304,352H168V232a8,8,0,0,0-8-8H16a8,8,0,0,0-8,8V488a8,8,0,0,0,8,8H304a8,8,0,0,0,8-8V360A8,8,0,0,0,304,352Zm-88,16h32v32H216ZM72,240h32v32H72Zm-48,0H56v40a8,8,0,0,0,8,8h48a8,8,0,0,0,8-8V240h32V352H24ZM72,368h32v32H72Zm-48,0H56v40a8,8,0,0,0,8,8h48a8,8,0,0,0,8-8V368h32V480H24ZM296,480H168V368h32v40a8,8,0,0,0,8,8h48a8,8,0,0,0,8-8V368h32Z" />
                                    <rect x="264" y="448" width="16" height="16" />
                                    <rect x="120" y="320" width="16" height="16" />
                                    <path d="M478.123,111.776A7.941,7.941,0,0,0,480,112a8.023,8.023,0,0,0,6.926-3.984,8.237,8.237,0,0,0,1.074-4.2V72a8,8,0,0,0-6.123-7.776l-232-56a7.967,7.967,0,0,0-3.754,0l-232,56A8,8,0,0,0,8,72v31.773a8.322,8.322,0,0,0,1.374,4.718,8.013,8.013,0,0,0,8.5,3.285L32,108.367V208H48V104.505L248,56.229l200,48.276V480H400V168a8,8,0,0,0-8-8H104a8,8,0,0,0-8,8v32a8,8,0,0,0,8,8H384v16H184v16H384v16H184v16H384v16H184v16H384V480H328v16H488V480H464V108.367ZM112,192V176H384v16ZM248,40a7.943,7.943,0,0,0-1.877.224L24,93.839V78.3l224-54.07L472,78.3v15.54L249.877,40.224A7.943,7.943,0,0,0,248,40Z" />
                                    <path d="M264,136a24,24,0,0,0,0-48H232a24,24,0,0,0,0,48Zm-40-24a8.009,8.009,0,0,1,8-8h32a8,8,0,0,1,0,16H232A8.009,8.009,0,0,1,224,112Z" />
                                </g>
                            </svg>
                        </div>
                        <div class="warehouse__text">
                            <h3 class="warehouse__h3">
                                Хранение
                            </h3>
                            <p class="warehouse__p">
                                Склады оборудованы
                                камерами слежения
                                и охраной
                            </p>
                        ...
                        <div class="warehouse__img">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 512 512" width="512" height="512">
                                <g id="outline">
                                    ...
                                    <path d="M396.885,226.06l15.654-3.311a159.737,159.737,0,0,0-4.324-16.185L393,211.5A143.423,143.423,0,0,1,396.885,226.06Z" />
                                    <path d="M387.6,197.438l14.613-6.514A159.893,159.893,0,0,0,394.6,176l-13.85,8.012A144.047,144.047,0,0,1,387.6,197.438Z" />
                                    <path d="M239.026,415.109a162.471,162.471,0,0,0,16.709.89l.026-16a146.142,146.142,0,0,1-15.055-.8Z" />
                                    <path d="M139.38,340.492l-12.949,9.4a160.8,160.8,0,0,0,10.527,13.018l11.9-10.695A145.314,145.314,0,0,1,139.38,340.492Z" />
                                    ...
                                    <path d="M211.578,118.979l-4.93-15.22a159.361,159.361,0,0,0-15.644,6l6.506,14.617A143.736,143.736,0,0,1,211.578,118.979Z" />
                                    <path d="M241.021,112.769l-1.642-15.916a160.692,160.692,0,0,0-16.542,2.588l3.3,15.657A143.628,143.628,0,0,1,241.021,112.769Z" />
                                    <path d="M272.8,96.871A162.463,162.463,0,0,0,256.089,96l-.008,16a146.433,146.433,0,0,1,15.055.785Z" />
                                    <path d="M305.517,103.812a160.3,160.3,0,0,0-16.178-4.333l-3.322,15.651a144,144,0,0,1,14.552,3.9Z" />
                                    <path d="M372.35,340.863l12.92,9.44a161,161,0,0,0,9.156-14.014l-13.832-8.041A144.874,144.874,0,0,1,372.35,340.863Z" />
                                    <path d="M327.778,380.864l7.989,13.864a160.856,160.856,0,0,0,14.051-9.108l-9.39-12.953A144.789,144.789,0,0,1,327.778,380.864Z" />
                                    <path d="M175.787,394.47a160.228,160.228,0,0,0,14.9,7.634l6.539-14.6a143.939,143.939,0,0,1-13.407-6.869Z" />
                                    <path d="M352.154,363.2,362.842,375.1A161.4,161.4,0,0,0,374.7,363.287l-11.867-10.732A145.267,145.267,0,0,1,352.154,363.2Z" />
                                    <path d="M387.468,314.848l14.6,6.545a159.379,159.379,0,0,0,6.038-15.623L392.9,300.8A143.733,143.733,0,0,1,387.468,314.848Z" />
                                    <path d="M300.271,393.069l4.912,15.227a159.193,159.193,0,0,0,15.652-5.979l-6.49-14.625A143.129,143.129,0,0,1,300.271,393.069Z" />
                                    <path d="M115.148,225.9,99.5,222.577a160.359,160.359,0,0,0-2.616,16.538l15.912,1.67A144.113,144.113,0,0,1,115.148,225.9Z" />
                                    <path d="M112,256v-.168H96V256a162.16,162.16,0,0,0,.845,16.535l15.916-1.637A146.2,146.2,0,0,1,112,256Z" />
                                    <path d="M270.82,399.247l1.625,15.918a160.779,160.779,0,0,0,16.543-2.57l-3.279-15.66A144.624,144.624,0,0,1,270.82,399.247Z" />
                                    <path d="M124.467,197.3l-14.608-6.529a159.819,159.819,0,0,0-6.019,15.63l15.213,4.955A143.709,143.709,0,0,1,124.467,197.3Z" />
                                    <path d="M115.083,285.784l-15.658,3.293a159.813,159.813,0,0,0,4.306,16.191l15.225-4.922A143.21,143.21,0,0,1,115.083,285.784Z" />
                                    <path d="M396.818,286.252l15.647,3.346a160.286,160.286,0,0,0,2.635-16.536l-15.911-1.687A144.248,144.248,0,0,1,396.818,286.252Z" />
                                    <path d="M159.727,148.912l-10.7-11.894a161.786,161.786,0,0,0-11.845,11.828l11.879,10.718A145.863,145.863,0,0,1,159.727,148.912Z" />
                                    <path d="M139.557,171.266l-12.93-9.426a161.147,161.147,0,0,0-9.142,14.023l13.842,8.026A144.622,144.622,0,0,1,139.557,171.266Z" />
                                    <path d="M184.084,131.215l-8-13.856a161.2,161.2,0,0,0-14.044,9.124l9.406,12.944A144.381,144.381,0,0,1,184.084,131.215Z" />
                                    <path d="M384,256A128,128,0,1,0,256,384,128.146,128.146,0,0,0,384,256ZM256,368A112,112,0,1,1,368,256,112.127,112.127,0,0,1,256,368Z" />
                                    ...
                                    <path d="M256,64C150.131,64,64,150.131,64,256s86.131,192,192,192,192-86.131,192-192S361.869,64,256,64Zm0,368c-97.047,0-176-78.953-176-176S158.953,80,256,80s176,78.953,176,176S353.047,432,256,432Z" />
                                </g>
                            </svg>
                    ...
                    <div class="warehouse__item">
                        <div class="warehouse__img">
                            <svg fill="#fff" enable-background="new 0 0 511.988 511.988" height="512" viewBox="0 0 511.988 511.988" width="512" xmlns="http://www.w3.org/2000/svg">
                                <g>
                    ...
                    <div class="warehouse__item">
                        <div class="warehouse__img">
                            <svg fill="#fff" enable-background="new 0 0 480.001 480.001" height="512" viewBox="0 0 480.001 480.001" width="512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="warehouse__item">
                        <div class="warehouse__img">
                            <svg fill="#fff" enable-background="new 0 0 64 64" height="512" viewBox="0 0 64 64" width="512" xmlns="http://www.w3.org/2000/svg">
                                <g>
                    ...
                    <div class="warehouse__item">
                        <div class="warehouse__img">
                            <svg fill="#fff" height="512pt" fill="#FE9934" viewBox="0 0 512.00005 512" width="512pt" xmlns="http://www.w3.org/2000/svg">
                                <path d="m222.5 382.152344c-2.652344 0-5.195312-1.054688-7.070312-2.929688l-108.734376-108.730468c-3.90625-3.90625-3.90625-10.238282 0-14.144532l56.566407-56.566406c3.90625-3.90625 10.238281-3.90625 14.144531 0l45.09375 45.09375 112.09375-112.097656c1.875-1.875 4.421875-2.929688 7.074219-2.929688 2.648437 0 5.195312 1.054688 7.070312 2.929688l56.566407 56.570312c3.90625 3.902344 3.90625 10.234375 0 14.140625l-175.734376 175.738281c-1.875 1.875-4.417968 2.925782-7.070312 2.925782zm-94.589844-118.730469 94.589844 94.589844 161.59375-161.59375-42.425781-42.429688-112.097657 112.097657c-3.90625 3.90625-10.238281 3.90625-14.140624 0l-45.09375-45.09375zm0 0" />
                                <path d="m255.9375 512c-6.53125 0-13.070312-.25-19.621094-.75-60.835937-4.664062-118.132812-31.027344-161.335937-74.226562-48.351563-48.355469-74.980469-112.640626-74.980469-181.023438 0-68.378906 26.628906-132.667969 74.980469-181.019531 48.351562-48.351563 112.640625-74.980469 181.019531-74.980469 68.382812 0 132.667969 26.628906 181.023438 74.980469 43.199218 43.203125 69.5625 100.5 74.226562 161.335937 4.613281 60.175782-12.144531 120.15625-47.183594 168.898438-3.222656 4.484375-9.472656 5.503906-13.957031 2.28125s-5.503906-9.472656-2.28125-13.957032c67.726563-94.207031 57.234375-222.230468-24.949219-304.417968-92.015625-92.015625-241.738281-92.015625-333.753906 0-92.019531 92.019531-92.019531 241.738281 0 333.757812 82.183594 82.179688 210.210938 92.675782 304.417969 24.945313 4.484375-3.222657 10.730469-2.199219 13.957031 2.285156 3.222656 4.484375 2.199219 10.730469-2.285156 13.957031-43.4375 31.226563-95.804688 47.933594-149.277344 47.933594zm0 0" />
                                <path d="m429.953125 439.953125c-2.632813 0-5.210937-1.070313-7.070313-2.929687-1.859374-1.863282-2.929687-4.441407-2.929687-7.070313 0-2.632813 1.070313-5.210937 2.929687-7.070313 1.859376-1.859374 4.4375-2.929687 7.070313-2.929687 2.628906 0 5.207031 1.070313 7.070313 2.929687 1.859374 1.859376 2.929687 4.4375 2.929687 7.070313 0 2.628906-1.070313 5.207031-2.929687 7.070313-1.863282 1.859374-4.441407 2.929687-7.070313 2.929687zm0 0" />
                            </svg>
                    ...
                    <div class="warehouse__item">
                        <div class="warehouse__img">
                            <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" viewBox="0 0 60 60" version="1.1">
                ...
                <div class="warehouse__btn">
                    <a data-fancybox data-src="#popup_warehouse" class="first-screen-text__btn btn main-btn">
                        <span class="btn__text">Подробнее</span>
                    </a>
                </div>
            ...
            <div class="our-advantages">
                ...
                <div class="our-advantages__row">
                    <div class="our-advantages__item">
                        <img src="http://dress.movehome.eu/wp-content/uploads/sites/5/2021/04/preimushhestva-gruzovik11.png" alt="">
                    </div>

                    <div class="our-advantages__item">
                        <h3 class="our-advantages__h3">
                            НАШИ ПРЕИМУЩЕСТВА
                        </h3>
                        <span class="our-advantages__descr">
                            Наша компания сделает так, чтобы каждая заключенная сделка стала для выгодной и успешной
                        </span>

                        <ul class="advantages__list advantages-list">
                            <li class="advantages-list__item advantages-item">
                                <div class="advantages-item__item advantages-item__item_blue">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                        <g>
                                            <g>
                                                <path d="M298.462,33.641C266.801,12.25,229.789,0.944,191.428,0.944C85.875,0.944,0,86.818,0,192.372    s85.875,191.428,191.428,191.428c4.208,0,7.619-3.411,7.619-7.619c0-4.208-3.41-7.619-7.619-7.619    c-97.152,0-176.191-79.039-176.191-176.191S94.277,16.182,191.428,16.182c35.308,0,69.37,10.403,98.505,30.087    c3.487,2.356,8.222,1.438,10.578-2.048C302.866,40.733,301.95,35.997,298.462,33.641z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path d="M300.212,340.745c-2.35-3.492-7.084-4.419-10.574-2.069c-19.395,13.045-40.814,21.962-63.665,26.503    c-4.127,0.82-6.808,4.83-5.987,8.958c0.72,3.626,3.903,6.136,7.465,6.136c0.492,0,0.991-0.048,1.493-0.148    c24.841-4.936,48.122-14.627,69.199-28.805C301.634,348.972,302.56,344.237,300.212,340.745z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path d="M299.672,293.227c-2.929-3.021-7.752-3.1-10.773-0.17c-26.286,25.469-60.855,39.456-97.451,39.456    c-0.357,0-0.716-0.001-1.073-0.004c-37.032-0.276-71.851-14.853-98.043-41.045c-26.468-26.468-41.044-61.66-41.044-99.093    c0-37.434,14.577-72.626,41.044-99.093c26.192-26.187,61.01-40.761,98.043-41.037c37.029-0.26,71.983,13.733,98.524,39.446    c3.023,2.928,7.845,2.85,10.772-0.172c2.928-3.022,2.852-7.845-0.171-10.773c-29.43-28.511-68.21-44.019-109.24-43.739    c-41.058,0.306-79.663,16.465-108.703,45.499C52.211,111.848,36.05,150.867,36.05,192.371c0,41.504,16.161,80.523,45.507,109.868    c29.039,29.039,67.644,45.201,108.703,45.507c0.398,0.003,0.791,0.004,1.19,0.004c40.572,0,78.906-15.511,108.052-43.751    C302.524,301.072,302.6,296.249,299.672,293.227z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path d="M199.047,185.248v-56.117c15.813,2.784,27.68,14.043,27.68,27.477c0,4.208,3.411,7.619,7.619,7.619    c4.208,0,7.619-3.411,7.619-7.619c0-21.699-18.654-39.726-42.918-42.89v-7.18c0-4.208-3.411-7.619-7.619-7.619    s-7.619,3.411-7.619,7.619v7.18c-24.264,3.163-42.918,21.191-42.918,42.89s18.654,39.727,42.918,42.891v56.117    c-15.812-2.785-27.68-14.044-27.68-27.478c0-4.208-3.411-7.619-7.619-7.619c-4.208,0-7.619,3.411-7.619,7.619    c0,21.699,18.654,39.726,42.918,42.89v7.18c0,4.208,3.411,7.619,7.619,7.619s7.619-3.411,7.619-7.619v-7.18    c24.264-3.163,42.918-21.191,42.918-42.89S223.311,188.411,199.047,185.248z M183.811,184.086    c-15.813-2.785-27.68-14.044-27.68-27.478s11.867-24.693,27.68-27.478V184.086z M199.047,255.614v-54.956    c15.813,2.786,27.68,14.044,27.68,27.478S214.86,252.829,199.047,255.614z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path d="M511.466,386.299c-1.149-2.908-3.958-4.819-7.086-4.819h-48.033V260.395c0-4.208-3.41-7.619-7.619-7.619    c-4.209,0-7.619,3.411-7.619,7.619v128.703c0,4.208,3.41,7.619,7.619,7.619h36.373l-102.795,96.281L279.51,396.717h36.373    c4.209,0,7.619-3.411,7.619-7.619V16.182H441.11v213.736c0,4.208,3.41,7.619,7.619,7.619c4.209,0,7.619-3.411,7.619-7.619V8.563    c0-4.208-3.41-7.619-7.619-7.619H315.882c-4.209,0-7.619,3.411-7.619,7.619v372.917h-48.033c-3.127,0-5.937,1.911-7.086,4.819    c-1.149,2.908-0.404,6.223,1.877,8.36l122.076,114.339c1.465,1.372,3.336,2.058,5.208,2.058s3.743-0.686,5.208-2.058    l122.075-114.34C511.872,392.522,512.616,389.206,511.466,386.299z">
                                                </path>
                                            </g>
                                        </g>
                                ...
                                <div class="advantages-item__item">
                                    <span>
                                        Дешевое <br>
                                        прохождение таможни
                                    </span>
                            ...
                            <li class="advantages-list__item advantages-item">
                                <div class="advantages-item__item advantages-item__item_yellow">
                                    <svg xmlns="http://www.w3.org/2000/svg" height
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="example__row">
                    ...
                    <div class="example__item">
                        <div class="example-item">
                            <div class="example-item__item">
                                ...
                                <p>
                                    Найти поставщика верхней одежды из Италии.
                                    Проверить качество товара и доставить его до получателя в Москву с таможенным
                                    оформлением.
                                </p>
                            </div>
                            <div class="example-item__item">
                                ...
                                <p>
                                    Нашли фабрику в Милане и проверили качество пуховиков и дубленок.
                                    Оплатили по контракту от нашей российской компании за 120 кг – вышло 850 евро.
                                    Логистика Милан - Москва 7 дней в составе сборного груза
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="example__item">
                        <div class="example__item_img">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/white-blank-cotton-thirt-presented-near-japanese-selvedge-jeans-and-leather-shoes-on-wooden-big-cargo-box-with-vitage-playballs-on-top.jpg" alt="">
                        </div>
                    </div>
    ...
    <section class="section-page-form" id="anchor-form">
        <div class="page-form">
            <div class="container">
                <div class="page-form__row">
                    <div class="page-form__item page-form__item_big">
                        <h2 class="sub-h2 sub-h2_dress">
                            БЕСПЛАТНЫЙ РАСЧЕТ СТОИМОСТИ
                        </h2>
                        <?php echo do_shortcode('[contact-form-7 id="16" title="главная форма"]') ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="footer-content__row">
                <div class="footer-content__item">
                    <div>
                        <a target="_blank" href="https://movehome.eu/" class='footer-dress__logo'>
                            <span class="header-dress__logo-name">
                                <img src="https://movehome.eu/wp-content/uploads/2020/03/move_home_2.png" alt="">
                            </span>
                        </a>
                    ...
                    <p>
                        <span class="bold">Секрет нашего успеха прост</span>: сделать выгодное ценовое предложение и
                        не
                        подводить заказчика по
                        срокам. Мы внимательны к своим клиентам и их имуществу, мы требовательны к своим
                        сотрудникам.
                    </p>
                </div>
                <div class="footer-content__item">
                    ...
                    <ul class='footer-dress__list'>
                        <li class=''>
                            <a target="_blank" href='#customs_clearance' class='footer-dress__link'>
                                <span class="link-hover">
                                    таможенное оформление
                                </span>
                            </a>
                        ...
                        <li class=''>
                            <a target="_blank" href='#logistic_services' class='footer-dress__link'>
                                <span class="link-hover">
                                    логистика
                                </span>
                            </a>
                        ...
                        <li class=''>
                            <a target="_blank" href='#providers' class='footer-dress__link'>
                                <span class="link-hover">
                                    поставщики
                                </span>
                            </a>
                        ...
                        <li class=''>
                            <a target="_blank" href='#financial_services' class='footer-dress__link'>
                                <span class="link-hover">
                                    финансовые услуги
                                </span>
                            </a>
                        ...
                        <li class=''>
                            <a target="_blank" href='#anchor-form' class='footer-dress__link'>
                                <span class="link-hover">
                                    оставить заявку
                                </span>
                            </a>
            ...
            <div class="footer-content__row">
                <div class="footer-content__item_confed">
                    <div class="footer-confed">
                        <div class="footer-confed__col">
                            <a class="footer-confed__link" href="https://movehome.eu/privacy/"><span>Политика
                                    конфендциальности</span></a>
                            <a class="footer-confed__link" href="https://movehome.eu/politika-ispolzovaniya-cookie-fajlov/"><span>Политика
                                    использования cookie-файлов</span></a>
                        </div>
                        <div class="footer-confed__col">
                            <a class="footer-confed__link" href="https://movehome.eu/politika-bezopasnosti-veb-sajta/"><span>Политика
                                    безопасности</span></a>
                            <a class="footer-confed__link" href="https://movehome.eu/termsofuse/"><span>Пользовательское
                                    соглашение</span></a>
                        </div>
                        <div class="footer-confed__col">

                            <a class="footer-confed__link" href="https://movehome.eu/politika-obrabotki-personalnih-dannyh/"><span>Политика
                                    обработки персональных данных</span></a>
                        </div>
...
<div class="popups-container">
    <!-- POPUP-auto -->
    <div id="popup_auto" class="popup">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                <!-- close -->
                <!-- title -->
                ...
                <div class="popup__body">
                    ...
                    <div class="popup__text">
                        ...
                        <p class="popup__p">
                            Перевозки с полной и частичной загрузкой, а также доставляем даже самые маленькие грузы.
                            Международные автоперевозки сборных грузов обычно выполняются еврофурами. Мы
                            организовываем
                            автомобильные грузоперевозки из США, Китая или Европейского Союза во все регионы России.

                        </p>
                        <p class="popup__p">
                            Путь от склада-отправителя до заказчика занимает в среднем от 5-7 до 10-12 дней. На
                            международных маршрутах работа автотранспорта может быть составной частью перевозок по
                            схемам «авиа + авто» и «море + авто».
                        </p>

                        <div class="popup__content-img-container">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/arriving-white-truck-on-the-road-in-a-rural-landscape-at-sunset.jpg" alt="">
                        </div>
                    ...
                    <div class="popup__form">
                        <div class="popup__img">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/car2.jpg" alt="">
                        </div>
                        <h3 class="popup__h3">
                            Оставьте заявку и мы свяжемся с вами в ближайшее время
                        </h3>
                        <?php echo do_shortcode('[contact-form-7 id="40" title="краткая"]') ?>
                    </div>
                </div>
                <!-- title -->
            </div>
    ...
    <!-- POPUP-auto -->
    <div id="popup_complex" class="popup">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                ...
                <div class="popup__body">
                    ...
                    <div class="popup__text">
                        ...
                        <div class="popup__content-img-container">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/foreman-control-loading-containers-box-to-truck-1.jpg" alt="">
                        </div>
                    </div>

                    <div class="popup__form">
                        <div class="popup__img">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/dostavka_sb_gruzov.jpg" alt="">
                        </div>
                        <h3 class="popup__h3">
                            Оставьте заявку и мы свяжемся с вами в ближайшее время
                        </h3>
            ...
            <div class="popup__content">
                ...
                <div class="popup__body">
                    ...
                    <div class="popup__text">
                        ...
                        <p class="popup__p">
                            это самый лучший способ транспортировки товаров, требующих быстрой доставки.
                            Единственным недостатком экспортно-импортных авиаперевозок являются довольно высокие
                            тарифы.

                        </p>
                        <p class="popup__p">
                            В сотрудничестве с различными партнерами мы осуществляем авиаперевозки по всему миру. Мы
                            обеспечим доставку груза в нужный аэропорт, оформим страховку и оформим всю необходимую
                            таможенную и сопроводительную документацию.
                        </p>
                        <div class="popup__content-img-container">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/logistics-transport-import-export-shipping-service-customers-order-things-2.jpg" alt="">
                        </div>
                    </div>

                    <div class="popup__form">
                        <div class="popup__img">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/avia_mini.jpg" alt="">
                        </div>
                        <h3 class="popup__h3">
                            Оставьте заявку и мы свяжемся с вами в ближайшее время
                        </h3>
            ...
            <div class="popup__content">
                ...
                <div class="popup__body">
                    ...
                    <div class="popup__text">
                        ...
                        <p class="popup__p">
                            Входит в схемы мультимодальной доставки грузов из Вьетнама, Израиля, Индии, Индонезии,
                            Канады, Кореи, Сингапура, США, Таиланда, Тайваня, Японии. Морская часть пути в среднем
                            занимает около месяца. По прибытии отправления перегружаются на автотранспорт, который
                            развозит их в пункты назначения.
                        </p>
                        <p class="popup__p">
                            Мы предлагаем: транспорт из порта в порт / от порога до порога, таможенные услуги и
                            оформление документов, страхование грузов, персональный подход к каждому нашему клиенту
                        </p>
                        <div class="popup__content-img-container">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/aerial-view-of-container-cargo-ship-in-sea.jpg" alt="">
                        </div>
                    </div>

                    <div class="popup__form">
                        <div class="popup__img">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/ship_mini.jpg" alt="">
                        </div>
                        <h3 class="popup__h3">
                            Оставьте заявку и мы свяжемся с вами в ближайшее время
                        </h3>
    ...
    <!-- POPUP-warehouse -->
    <div id="popup_warehouse" class="popup" style="max-width:550px !important">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                ...
                <div class="popup__body">
                    <div class="popup__form">
                        <h3 class="popup__h3">
                            Оставьте заявку чтобы узнать больше о складских услугах Move Home
                        </h3>
                        <?php echo do_shortcode('[contact-form-7 id="40" title="краткая"]') ?>
                    </div>
                </div>
    ...
    <!-- POPUP-safe -->
    <div id="popup_safe" class="popup" style="max-width:550px !important">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                ...
                <div class="popup__body">
                    <div class="popup__form">
                        <h3 class="popup__h3">
                            Оставьте заявку чтобы узнать больше о страховых услугах Move Home
                        </h3>
                        <?php echo do_shortcode('[contact-form-7 id="40" title="краткая"]') ?>
                    </div>
                </div>
    ...
    <!-- POPUP-safe -->
    <div id="popup_finance" class="popup" style="max-width:550px !important">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                ...
                <div class="popup__body">
                    <div class="popup__form">
                        <h3 class="popup__h3">
                            Оставьте заявку чтобы узнать больше о финансовых услугах ВЭД Move Home
                        </h3>
                        <?php echo do_shortcode('[contact-form-7 id="40" title="краткая"]') ?>
                    </div>
                </div>
    ...
    <!-- POPUP-kids-dress -->
    <div id="popup_kids-dress" class="popup">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                ...
                <div class="popup__body">
                    ...
                    <div class="popup__text">
                        <h2 class="popup__h2">
                            Оперативная доставка одежды с услугами таможенного оформления от 5 евро за 1 килограмм
                        </h2>
                        <p class="popup__p">
                            Наша компания занимается доставкой любой одежды из Европы, США и Китая в Россию, а также в страны СНГ

                        </p>
                        <p class="popup__p">
                            Move Home предлагает экспресс доставку одежды от 1 до 3 дней, с учетом прохождения таможни (в составе сборного груза доставка займёт от 12 до 16 дней), из любой точки мира

                        </p>
                        <p class="popup__p">
                            Поиск нужного поставщика одежды занимает от 3 до 5 дней, в стоимость этой услуги входит таможенное оформление и логистика до дверей
                        </p>
                        <p class="popup__p">
                            Наша компания может оплатить услуги поставщика, что позволит вам сэкономить на закупке одежды до 25% от ее рыночной стоимости.
                            Закрывающие документы, номер ТД, вся нетарифная документация (сертификаты, декларации, СГР от различных лабораторий) по ценам ниже рыночных, маркировка согласно всем правилам, включая регистрацию в Честном Знаке
                        </p>
                        <p class="popup__p">
                            Мы застрахуем вашу одежду от 0.5% от ее стоимости на всем пути следования. Страхование начиная с закупки товара, заканчивая его получением в вашем городе
                        </p>
                        <p class="popup__p">
                            В нашем управлении имеются собственные склады консолидации в 32 странах мира. Вы можете заказывать одежду из любых интернет-магазинов с доставкой прямо на них.
                            Для этого вам необходимо связаться с нашим оператором. Мы гарантируем оперативную обработку заявки и соблюдение всех требований законодательства
                        </p>
                    ...
                    <div class="popup__form">
                        <div class="popup__img">
                            <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/05/close-up-woman-holding-box-with-service-delivery-and-holding-a-board.jpg" alt="">
                        </div>
                        <h3 class="popup__h3">
                            Оставьте заявку и мы свяжемся с вами в ближайшее время
                        </h3>
    ...
    <!-- POPUP-shoes-->
    <div id="popup_shoes" class="popup">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                ...
                <div class="popup__body">
                    ...
                    <div class="popup__text">
                        <h2 class="popup__h2">
                            Быстрая доставка обуви с услугами таможенного оформления от 5 € за 1 кг
                        </h2>
                        <p class="popup__p">

                            Наша компания занимается доставкой обуви любых брендов из Европы, США и Китая в Россию, а также в страны СНГ

                        </p>
                        <p class="popup__p">
                            Move Home предлагает экспресс доставку обуви от 1 до 3 дней, с учетом прохождения таможни, либо за 12-16 дней в составе сборного груза из любой точки мира.
                            Подберем специально для вас лучшего поставщика обуви. Поиск занимает от 3 до 5 дней, в стоимость этой услуги входит таможенное оформление и логистика до дверей
                        ...
                        <p class="popup__p">
                            Предлагаем услуги страхования обувной продукции. Застрахуем от 0.5% от стоимости партии, действует на всем пути следования. Страхование от закупки товара, до его получения в вашем городе
                        </p>
                        <p class="popup__p">
                            В нашем управлении имеются собственные склады консолидации в 32 странах мира. Вы можете заказывать обувь из любых интернет-магазинов с доставкой прямо на них.
                            Для этого вам необходимо связаться с нашим оператором. Мы гарантируем оперативную обработку заявки и соблюдение всех требований законодательства
        ...
        <div class="popup__body">
            <div class="popup__content">
                ...
                <div class="popup__body">
                    ...
                    <div class="popup__text">
                        <h2 class="popup__h2">
                            Быстрая доставка сумок с возможностью таможенного оформления от 5 € за 1 кг
                        </h2>
                        <p class="popup__p">
                            Наша компания занимается доставкой мужских и женских сумок любых брендов из Европы, США и Китая в Россию и страны СНГ
                        </p>
                        <p class="popup__p">
                            Move Home предлагает оперативную доставку сумок от 1 до 3 дней, с учетом прохождения таможни, либо за 12-16 дней в составе сборного груза из любой точки мира.
                            Отсортируем поставщиков сумок и выберем подходящего вашим запросам. Подбор занимает от 3 до 5 дней, в стоимость этой услуги входит таможенное оформление и доставка до дверей
                        </p>
                        <p class="popup__p">
                            Move Home предлагает оперативную доставку сумок от 1 до 3 дней, с учетом прохождения таможни, либо за 12-16 дней в составе сборного груза из любой точки мира.
                            Отсортируем поставщиков сумок и выберем подходящего вашим запросам. Подбор занимает от 3 до 5 дней, в стоимость этой услуги входит таможенное оформление и доставка до дверей
                        ...
                        <p class="popup__p">
                            Наша компания может оплатить услуги поставщика, что позволит вам сэкономить на закупке сумок до 25% от ее рыночной стоимости.
                            Закрывающие документы, номер ТД, вся нетарифная документация (сертификаты, декларации, СГР от различных лабораторий) по ценам ниже рыночных, маркировка согласно всем правилам, включая регистрацию в Честном Знаке
                        </p>
                        <p class="popup__p">
                            Специально для вас действуют услуги страхования сумок на особых условиях. Застрахуем от 0.5% от стоимости партии, действует на всем пути следования. Страхование от закупки товара, до его получения в пункте назначения
                        </p>
                        <p class="popup__p">
                            В нашем управлении имеются собственные склады консолидации в 32 странах мира. Вы можете заказывать обувь из любых интернет-магазинов с доставкой прямо на них.
                            Для этого вам необходимо связаться с нашим оператором. Мы гарантируем оперативную обработку заявки и соблюдение всех требований законодательства.
    ...
    <!-- POPUP-second-->
    <div id="popup_second" class="popup">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                ...
                <div class="popup__body">
                    ...
                    <div class="popup__text">
                        <h2 class="popup__h2">
                            Предлагаем вам доставку second-hand с таможенного оформления от 5 € за 1 кг
                        </h2>
                        <p class="popup__p">
                            Наша компания занимается доставкой second-hand одежды и обуви из Европы, США и Китая в Россию и страны СНГ

                        </p>
                        <p class="popup__p">
                            Move Home обеспечит оперативную доставку second-hand товаров от 1 до 3 дней, с учетом прохождения таможни, либо за 12-16 дней в составе сборного груза из любой точки мира.
                            Отсортируем поставщиков second hand и выберем подходящего вашим запросам. Подбор занимает от 3 до 5 дней, в стоимость этой услуги входит таможенное оформление и доставка до дверей

                        </p>
                        <p class="popup__p">
                            Наша компания оплатит услуги поставщика, что позволит вам сэкономить на закупке second-hand до 25% от ее рыночной стоимости.
                            Закрывающие документы, номер ТД, вся нетарифная документация (сертификаты, декларации, СГР от различных лабораторий) по ценам ниже рыночных, маркировка согласно всем правилам, включая регистрацию в Честном Знаке

                        </p>
                        <p class="popup__p">
                            Специально для вас действуют услуги страхования second hand на особых условиях. Застрахуем от 0.5% от стоимости партии, действует на всем пути следования. Страхование от закупки товара, до его получения в пункте назначения
...
<script>
    document.addEventListener('wpcf7mailsent', function sendMail(event) {
        if ('123' == event.detail.contactFormId) {
            // yandex
            yaCounter78111637.reachGoal('dressTop');

            console.log('Good Goal Top ');
        }
        if ('40' == event.detail.contactFormId) {
            // yandex
            yaCounter78111637.reachGoal('dressMini');


            console.log('Good Goal Mini ');
        }

        if ('16' == event.detail.contactFormId) {
            // yandex
            yaCounter78111637.reachGoal('dressMain');


            console.log('Good Goal Main ');
        }
