        ...
        <div class='header-dress__body'>
            ...
            <nav class='header-dress__menu'>
                ...
                <ul class='header-dress__list'>
                    <li class=''>
                        <a href='#customs_clearance' class='header-dress__link'>
                    ...
                    <li class=''>
                        <a href='#providers' class='header-dress__link'>
                            <span class="link-hover">
                                поставщики
                            </span>
                        </a>
                    ...
                    <li class=''>
                        <a href='#financial_services' class='header-dress__link'>
                            <span class="link-hover">
                                финансовые услуги
                            </span>
                        </a>
                    ...
                    <li class=''>
                        <a href='#section-warehouse' class='header-dress__link'>
                            <span class="link-hover">
                                логистика
                            </span>
                        </a>
                    ...
                    <li class=''>
                        <a data-fancybox data-src="#popup_short_main" class='header-dress__link'>
                            <span class="link-hover">
                                оставить заявку
                            </span>
                        </a>
        ...
        <div class="container">
            <div class="sub-header-dress">
                <div class="sub-header-dress__item">
                    ...
                    |
                    <a class="sub-header-dress__link" href="mailto:info@movehome.eu">
...
<main class="main">
    ...
    <section class="section-page1">
        <div class="container">
            <div class="page1">
                <h1 class="page1__h1">
                    Грузоперевозки одежды и обуви из Европы в Россию для бизнеса от 5 евро за кг и сроком до 7 дней
                </h1>




                <a data-fancybox data-src="#popup_short_main" class="first-screen-text__btn btn main-btn">
                    ...
                    <div class="our-advantages__item">
                        ...
                        <ul class="advantages__list advantages-list">
                            ...
                            <li class="advantages-list__item advantages-item">
                                ...
                                <div class="advantages-item__item">
                                    Выгодное предложение по сертификации и маркировке
                                </div>
                            </li>
                ...
                <div class="dress-services__body">
                    ...
                    <div class="dress-services__item">
                        ...
                        <div>
                            ...
                            <a data-fancybox data-src="#popup_dress" class="first-screen-text__btn btn main-btn">
        ...
        <div class="container">
            <div class="provider">
                ...
                <span class="logistic__descr">
                    Поможем с поиском зарубежных поставщиков, а так же с закупкой товара на вашу компанию
                </span>
                ...
                <div class="provider__btn">
                    <a data-src="#popup_short_main" data-fancybox class="first-screen-text__btn btn main-btn">
                        <i aria-hidden="true" class="fas fa-calculator"></i>
                        <span class="btn__text">Экспресс расчёт стоимости</span>
                    </a>
                </div>
    ...
    <section id="financial_services" class="section-finance">
        <div class="finance">
            ...
            <div class="container">
                ...
                <span class="logistic__descr">
                    Заключение международного контракта, оплата товара в иностранной валюте и другое
                </span>
            ...
            <div class="footer-content__row">
                ...
                <div class="footer-content__item">
                    ...
                    <ul class='footer-dress__list'>
                        <li class=''>
                            <a  href='#customs_clearance' class='footer-dress__link'>
                                <span class="link-hover">
                                    таможенное оформление
                                </span>
                            </a>
                        ...
                        <li class=''>
                            <a  href='#providers' class='footer-dress__link'>
                                <span class="link-hover">
                                    поставщики
                                </span>
                            </a>
                        ...
                        <li class=''>
                            <a  href='#financial_services' class='footer-dress__link'>
                                <span class="link-hover">
                                    финансовые услуги
                                </span>
                            </a>
                        ...
                        <li class=''>
                            <a  href='#section-warehouse' class='footer-dress__link'>
                                <span class="link-hover">
                                    логистика
                                </span>
                            </a>
                        ...
                        <li class=''>
                            <a data-fancybox data-src="#popup_short_main" class='footer-dress__link'>
                                <span class="link-hover">
                                    оставить заявку
                                </span>
                            </a>
...
<div class="popups-container">
    ...
    <!-- POPUP-short-main -->
    <div id="popup_short_main" class="popup" style="max-width:550px !important">
        <div class="popup__body">
            <div class="popup__content">
                <!-- close -->
                <a href="" class="popup__close popup-close"><span class="close-x"></span></a>
                ...
                <div class="popup__body">
                    <div class="popup__form">
                        <h3 class="popup__h3">
                            Оставьте заявку чтобы узнать больше о поиске поставщиков Move Home
                        </h3>
                        <?php echo do_shortcode('[contact-form-7 id="40" title="краткая"]') ?>
                    </div>
                </div>
    ...
    <!-- POPUP-dress -->
    <div id="popup_dress" class="dress-popup">
        <div class="dress-popup__content">
            <header class="dress-popup__header">
                <h3 class="dress-popup__title">
                    Доставка одежды с услугами таможенного оформления от 5 евро
                </h3>

            </header>
            <div class="dress-popup__body">
                <div class="dress-popup__container">
                    <div class="finance">
                        <div class="finance__body-popup">
                            <div class="finance__item">
                                <div class="finance__text">
                                    <h3 class="finance__h3 acc-head">
                                        <span> Доставка и таможенное оформление</span>
                                        <span class="acc-arrow"></span>
                                    </h3>
                                    <div class="finance__p acc-body">

                                        <div class="finance__content">
                                            <div class="finance__img">
                                                <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/car-icon.png" alt="">
                                            </div>
                                            <div>
                                                <div>
                                                    <p>
                                                        Наша компания занимается доставкой
                                                        и помощью с таможнным оформлением
                                                        любой одежды из Европы, США и Китая
                                                        в Россию, а также в страны СНГ
                                                    </p>
                                                    <p class="finance__p-mob">
                                                        Move Home предлагает экспресс доставку
                                                        одежды за 1 -3 дня, с учетом таможни
                                                        (в составе сборного груза доставка
                                                        займёт 12 - 16 дней), из любой точки мира
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="finance__item finance__item_mob-hidden">
                                ...
                                <div class="finance__text">
                                    ...
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            <div class="finance__img">
                                                <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/sloj_25.png" alt="">
                                            </div>
                                            <p>
                                                Move Home предлагает экспресс доставку
                                                одежды за 1 -3 дня, с учетом таможни
                            ...
                            <div class="finance__item">
                                ...
                                <div class="finance__text">
                                    <h3 class="finance__h3 acc-head">
                                        <span>оплата и поиск поставщиков</span>
                                        <span class="acc-arrow"></span>
                                    </h3>
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            <div class="finance__img">
                                                <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/sloj_37.png" alt="">
                                            </div>
                                            <div>
                                                <p>
                                                    Поиск нужного поставщика одежды
                                                    занимает от 3 до 5 дней, в стоимость этой
                                                    услуги входит таможенное оформление
                                                    и логистика до дверей
                                                </p>
                                                <p class="finance__p-mob">
                                                    Наша компания может оплатить услуги
                                                    поставщика, что позволит вам сэкономить
                                                    на закупке одежды до 25% от ее рыночной
                                                    стоимости
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="finance__item finance__item_mob-hidden">
                                ...
                                <div class="finance__text">
                                    ...
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            <div class="finance__img">
                                                <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/sloj_38.png" alt="">
                                            </div>
                                            <p>
                                                Наша компания может оплатить услуги
                                                поставщика, что позволит вам сэкономить
                            ...
                            <div class="finance__item">
                                ...
                                <div class="finance__text">
                                    <h3 class="finance__h3 acc-head">
                                        <span> вся необходимая документация</span>
                                        <span class="acc-arrow"></span>
                                    </h3>
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            <div class="finance__img">
                                                <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/sloj_41.png" alt="">
                                            </div>
                                            <div>
                                                <p>
                                                    Закрывающие документы, номер ТД, вся
                                                    нетарифная документация (сертификаты,
                                                    декларации, СГР от различных
                                                    лабораторий) по ценам ниже рыночных
                                                </p>
                                                <p class="finance__p-mob">
                                                    Маркировка товаров производится
                                                    согласно всем правилам,включая
                                                    регистрацию в Честном
                                                    Знаке
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="finance__item finance__item_mob-hidden">
                                ...
                                <div class="finance__text">
                                    ...
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            <div class="finance__img">
                                                <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/sloj_40.png" alt="">
                                            </div>
                                            <p>
                                                Маркировка товаров производится
                                                согласно всем правилам,включая
                            ...
                            <div class="finance__item">
                                ...
                                <div class="finance__text">
                                    <h3 class="finance__h3 acc-head">
                                        <span> страховка и хранение товара</span>
                                        <span class="acc-arrow"></span>
                                    </h3>
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            <div class="finance__img">
                                                <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/sloj_45.png" alt="">
                                            </div>
                                            <div>
                                                <p>
                                                    Мы застрахуем вашу одежду от 0.5% от
                                                    ее стоимости на всем пути следования.
                                                    Страхование начиная с закупки товара,
                                                    заканчивая его получением в вашем городе
                                                </p>
                                                <p class="finance__p-mob">
                            ...
                            <div class="finance__item finance__item_mob-hidden">
                                ...
                                <div class="finance__text">
                                    ...
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            <div class="finance__img">
                                                <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/sloj_44-2-1.png" alt="">
                                            </div>
                                            <p>
                                                В нашем управлении имеются собственные склады консолидации в 32 странах мира. Вы можете заказывать одежду из любых интернет-магазинов с доставкой прямо на них.
                                                Для этого вам необходимо связаться с нашим оператором. Мы гарантируем оперативную обработку заявки и соблюдение всех требований законодательства.
                ...
                <div class="dress-popup__car-wrap">
                    <img src="https://dress.movehome.eu/wp-content/uploads/sites/5/2021/06/sloj_64_kopiya_2-1.png" alt="">
                </div>

            </div>

            <footer class="dress-popup__footer">
                <div class="dress-popup__container">
                    <h3 class="dress-popup__h3">
                        Оставьте контакты и мы в ближайшее время с вами свяжемся
                    </h3>
                    <?php echo do_shortcode('[contact-form-7 id="204" title="popup"]') ?>
                </div>
            </footer>
        </div>
    </div>
    ...
    <!-- POPUP-shoes -->
    <div id="popup_shoes" class="dress-popup">
        <div class="dress-popup__content">
            <header class="dress-popup__header">
                <h3 class="dress-popup__title">
                    Доставка обуви с услугами таможенного оформления от 5 евро
                </h3>
                                            ...
                                            <div>
                                                <div>
                                                    <p>
                                                        Наша компания занимается доставкой
                                                        и помощью с таможнным оформлением
                                                        любой обуви из Европы, США и Китая
                                                        в Россию, а также в страны СНГ
                                                    </p>
                                                    <p class="finance__p-mob">
                                                        Move Home предлагает экспресс доставку
                                                        обуви за 1 -3 дня, с учетом таможни
                                                        (в составе сборного груза доставка
                                                        займёт 12 - 16 дней), из любой точки мира
                                                    </p>
                                                </div>
                                ...
                                <div class="finance__text">
                                    ...
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            ...
                                            <div>
                                                <p>
                                                    Мы застрахуем вашу обувь от 0.5% от
                                                    ее стоимости на всем пути следования.
                                                    Страхование начиная с закупки товара,
                                                    заканчивая его получением в вашем городе
                                                </p>
    ...
    <!-- POPUP-bag -->
    <div id="popup_bag" class="dress-popup">
        <div class="dress-popup__content">
            <header class="dress-popup__header">
                <h3 class="dress-popup__title">
                    Доставка сумок с услугами таможенного оформления от 5 евро
                </h3>
                                            ...
                                            <div>
                                                <div>
                                                    <p>
                                                        Наша компания занимается доставкой
                                                        и помощью с таможнным оформлением
                                                        любых сумок из Европы, США и Китая
                                                        в Россию, а также в страны СНГ
                                                    </p>
                                                    <p class="finance__p-mob">
                                                        Move Home предлагает экспресс доставку
                                                        сумок за 1 -3 дня, с учетом таможни
                                                        (в составе сборного груза доставка
                                                        займёт 12 - 16 дней), из любой точки мира
                                                    </p>
                                                </div>
                                ...
                                <div class="finance__text">
                                    ...
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            ...
                                            <div>
                                                <p>
                                                    Поиск нужного поставщика сумок
                                                    занимает от 3 до 5 дней, в стоимость этой
                                                    услуги входит таможенное оформление
                                                    и логистика до дверей
                                                </p>
                                ...
                                <div class="finance__text">
                                    ...
                                    <div class="finance__p acc-body">
                                        ...
                                        <div class="finance__content">
                                            ...
                                            <div>
                                                <p>
                                                    Мы застрахуем ваши сумки от 0.5% от
                                                    их стоимости на всем пути следования.
                                                    Страхование начиная с закупки товара,
                                                    заканчивая его получением в вашем городе
                                                </p>
                                                <p class="finance__p-mob">
    ...
    <!-- POPUP-second -->
    <div id="popup_second" class="dress-popup">
        <div class="dress-popup__content">
            <header class="dress-popup__header">
                <h3 class="dress-popup__title">
                    Доставка одежды с услугами таможенного оформления от 5 евро
...
<script>
    ...
    function f_acc() {
        ...
        $('.acc-arrow').css('transform', 'rotate(0deg)')

        $(this).find('.acc-arrow').css('transform', 'rotate(90deg)')

        if ($(this).find('.acc-body').is(":visible")) {

            $('.acc-body').hide('slow');
            $(this).find('.acc-arrow').css('transform', 'rotate(0deg)')
            console.log('click1')

        } else {

            $(this).find('.acc-body').show('slow');
...
<script>
    document.addEventListener('wpcf7mailsent', function sendMail(event) {
        ...
        if ('204' == event.detail.contactFormId) {
            // yandex
            yaCounter78111637.reachGoal('dressPopupRow');
