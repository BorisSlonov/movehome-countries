            ...
            <div class="first-screen__row">
                <div class="first-screen__item first-screen-text">
                    ...
                    <h1 class="first-screen-text__title">
                        ...
                        <span class="sub-color">Италия | РОССИЯ</span>
                    </h1>
                    <div class="first-screen-text__countries first-countries">
                        <span class="first-countries__row">Доставляем груз: </span>

                        <span class="first-countries__row">из <span class="sub-color underline">Италии</span> в Россию;</span>

                        <span class="first-countries__row">из России в <span class="sub-color underline">Италию</span>;</span>
                ...
                <img src="https://movehome.eu/wp-content/uploads/2020/06/italiya-768x341.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="our-services__row">
                <div class="our-services__item">
                    ...
                    <p class="our-services__text">
                        Сервис для отправки посылок и товаров из интернет-магазина для себя и своих близких в Италию
                ...
                <div class="our-services__item">
                    ...
                    <p class="our-services__text">
                        Люди стали чаще переезжать в поисках лучшей жизни, и наша команда в Италии разработала выгодный
                ...
                <div class="our-services__item">
                    ...
                    <p class="our-services__text">
                        Экспресс-доставка грузов для бизнеса. Италия - популярная страна для покупки товаров от текстиля
                        до
        ...
        <div class="page-video">
            <div class="page-video__row">
                ...
                <div class="page-video__item">
                    <a data-fancybox  href="https://www.youtube.com/watch?v=UvsnWZnEYH4&t" class="video-link">
                        <img src="https://movehome.eu/wp-content/uploads/2021/01/mocitaly-1024x578.png" alt="">
        ...
        <div class="service">
            <div class="service__row">
                <div class="service__item">
                    ...
                    <img class="service__img service__img_germany" src="https://movehome.eu/wp-content/uploads/2021/01/karta-italiya-258x300.png" alt="">
                </div>
                <div class="service__item">
                    <h2 class='main-h2 main-h2_white'>
                        ОБСЛУЖИВАЕМ ВСЕ
                        ГОРОДА Италии И РОССИИ
                    </h2>
        ...
        <div class="text-left">
            <div class="text-left__row">
                <div class="text-left__item">
                    <h2 class="sub-h2">
                        ОРГАНИЗАЦИЯ ЗАКУПКИ ТОВАРА В Италии И В РОССИИ
                    </h2>
                    <p class="text-left__text">
                        <span>
                            Компания «MoveHome» осуществляет комплекс услуг по закупке и оплате товаров у Итальянских и
                            российских
                            производителей.
                        </span>
            ...
            <div class="text-right__row">
                ...
                <div class="text-right__item">
                    <h2 class="sub-h2 sub-h2_white">
                        ТАМОЖЕННОЕ ОФОРМЛЕНИЕ В Италии и России
                    </h2>
                    <p class="text-right__text">
                        <span>
                            Компания MoveHome помогает с таможенным оформлением в Италии. Мы имеем возможность оформлять
                        ...
                        <span class="text-p">
                            ...
                            пришедшие в Италию из третьих стран: Китай, Америка, Россия и прочие страны, не входящие в
...
<div class="container">
    ...
    <div class="container">
        ...
        <?php echo do_shortcode('[testimonial_view id="22"]') ?>
        ...
        <div id="app-accord" class="">
                ...
                <div class="reviews">
                    <?php echo do_shortcode('[testimonial_view id="23"]') ?>
                </div>
            </div>
    </div>
</section>
            ...
            <div class="footer-content__row">
                ...
                <div class="footer-content__item footer-contacts">
                    <div class="footer-contacts__item">
                        ...
                        Via Dante Alighieri, 134, Pioltello MI
                    </div>
                    <div class="footer-contacts__item">
                        <h3 class="footer-contacts__title">
                            Офис в России
...
<script>
    document.addEventListener('wpcf7mailsent', function sendMail(event) {
        if ('12973' == event.detail.contactFormId) {
            ...
            yaCounter56897875.reachGoal('italyTop')
        ...
        if ('12974' == event.detail.contactFormId) {
            ...
            yaCounter56897875.reachGoal('italyBottom')
